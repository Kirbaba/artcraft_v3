        ...
        <div class="container">
            ...
            <div class="home-projects__flex">
                ...
                <div class="home-projects__tabs show_site">
                    <a href="<?php bloginfo( 'template_directory' ); ?>/img/sites.jpg" class="home-projects__tabs_item"
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide home-steps__item">
                        ...
                        <div class="home-steps__item_description">
                            <!-- open .flexw -->
                            <div class="flexw">
                                <h3 class="home-steps__item_description_title" data-swiper-parallax="-100">СОЗДАНИЕ
                                    <br/><strong>ПРОТОТИПА</strong> <span>01</span></h3>
                    ...
                    <div class="swiper-slide home-steps__item">
                        ...
                        <div class="home-steps__item_description">
                            <!-- open .flexw -->
                            <div class="flexw">
                                <h3 class="home-steps__item_description_title" data-swiper-parallax="-100">РАЗРАБОТКА
                                    <br/><strong>ДИЗАЙНА</strong> <span>02</span></h3>
                                <div class="home-steps__item_description_text" data-swiper-parallax="-300">
