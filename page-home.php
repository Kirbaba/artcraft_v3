    ...
    while ( have_posts() ) : the_post(); // старт цикла
                        ...
                        <div class="home-services__flex">
                            <div class="home-services_item">
                                ...
                                <div class="home-services_icon">
                                    <img
                                        src="<?php bloginfo( 'template_directory' ); ?>/img/04298abddeeee76679ef90e2dcb1f72b.png"
                                        alt=""/>
                                </div>
                                ...
                                <ul class="home-services_list">
                                    ...
                                    <li><a href="#" class="js_service__item" data-price="23 000">Online-исследования</a>
                                    </li>
                                    <li><a href="#" class="js_service__item" data-price="28 000">Коммуникационная
                                            стратегия</a></li>
                            ...
                            <div class="home-services_item">
                                ...
                                <div class="home-services_icon">
                                    <img
                                        src="<?php bloginfo( 'template_directory' ); ?>/img/00179f806d7cfba4274a5d1705fa1ece.png"
                                        alt=""/>
                                </div>
                                <!-- close .home-services_icon -->
                                <!-- open .home-services_title -->
                                ...
                                <ul class="home-services_list">
                                    ...
                                    <li><a href="#" class="js_service__item" data-price="20 111">Информационный
                                            дизайн</a></li>
                                    <li><a href="#" class="js_service__item" data-price="20 999">Полиграфия</a></li>
                                    <li><a href="#" class="js_service__item" data-price="20 8888">Разработка платформы
                                            бренда</a></li>
                                    <li><a href="#" class="js_service__item" data-price="20 222">Нейминг, разработка
                                            слогана</a></li>
                                    <li><a href="#" class="js_service__item" data-price="20 855">Логотип, фирменный
                                            стиль</a></li>
                                </ul>
                                <!-- close .home-services_list -->
                            </div>
                            ...
                            <div class="home-services_item">
                                ...
                                <div class="home-services_icon">
                                    <img
                                        src="<?php bloginfo( 'template_directory' ); ?>/img/c64d6ce166af46960db44ea1213cbfb3.png"
                                        alt=""/>
                                </div>
                                <!-- close .home-services_icon -->
                                <!-- open .home-services_title -->
                                ...
                                <!-- open .home-services_list -->
                                <ul class="home-services_list">
                                    <li><a href="#" class="js_service__item" data-price="2 000">Техническое задание</a>
                                    </li>
                                    <li><a href="#" class="js_service__item" data-price="5 000">Веб-разработка</a></li>
                                    <li><a href="#" class="js_service__item" data-price="2 000">Адаптивный дизайн</a>
                                    </li>
                                    <li><a href="#" class="js_service__item" data-price="8 000">Адаптивный дизайн</a>
                                    </li>
                                </ul>
                                <!-- close .home-services_list -->
                            </div>
        ...
        <div class="section home-projects" id="moveto_projects">
            <div class="intro">
                <div class="container">
                    <h2>ПРОЕКТЫ</h2>
                    <h4>В данном разделе представлены только избранные проекты нашей компании за период с 2004
                        года.</h4>
                    <div class="home-projects__flex">
                        ...
                        <div class="home-projects__tabs show_site">
                            <a href="<?php bloginfo( 'template_directory' ); ?>/img/sites.jpg"
                               class="home-projects__tabs_item" data-modal="modal__project">
                                <img src="<?php bloginfo( 'template_directory' ); ?>/img/sites.jpg" alt=""/>
							<span class="home-projects__tabs_content">
								<h3>Rabbit Intelligence</h3>
								<p>If a rabbit defined intelligence the way man does, then the most intelligent animal would be a rabbit, followed by the animal most willing to obey the commands of a rabbit. <em>&mdash;
                                        Robert Brault</em></p>
                            ...
                            <a href="<?php bloginfo( 'template_directory' ); ?>/img/screencapture-bmw-web-artcraft-com-1454661116692.png"
                               class="home-projects__tabs_item" data-modal="modal__project">
                                <img
                                    src="<?php bloginfo( 'template_directory' ); ?>/img/screencapture-bmw-web-artcraft-com-1454661116692.png"
                                    alt=""/>
							<span class="home-projects__tabs_content">
								<h3>Русаковичь</h3>
                        ...
                        <div class="swiper-wrapper">
                                ...
                                <div class="home-steps__item_description">
                                    ...
                                    <div class="flexw">
                                        <h3 class="home-steps__item_description_title" data-swiper-parallax="-100">
                                            СОЗДАНИЕ <br/><strong>ПРОТОТИПА</strong> <span>01</span></h3>
                            ...
                            <div class="swiper-slide home-steps__item">
                                ...
                                <div class="home-steps__item_description">
                                    ...
                                    <div class="flexw">
                                        <h3 class="home-steps__item_description_title" data-swiper-parallax="-100">
                                            РАЗРАБОТКА <br/><strong>ДИЗАЙНА</strong> <span>02</span></h3>
                                        <div class="home-steps__item_description_text" data-swiper-parallax="-300">
                            ...
                            <div class="swiper-slide home-steps__item">
                                ...
                                <div class="home-steps__item_description">
                                    ...
                                    <div class="flexw">
                                        <h3 class="home-steps__item_description_title" data-swiper-parallax="-100">
                                            ПРОГРАММИРОВАНИЕ И <strong>ВЕРСТКА</strong> <span>03</span></h3>
                                        <div class="home-steps__item_description_text" data-swiper-parallax="-300">
